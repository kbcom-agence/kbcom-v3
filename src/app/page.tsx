    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="relative z-10 container-kb text-center px-4">
          ...
          <div className="relative max-w-4xl mx-auto mb-12">
            ...
            <div className="relative p-2 rounded-3xl bg-white/30 backdrop-blur-lg border border-white/50 shadow-2xl shadow-blue-500/10 overflow-hidden">
              {/* Gradient overlay gauche - plus large et plus fondu */}
              <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-white via-white/80 to-transparent z-10 pointer-events-none" />
              {/* Gradient overlay droite - plus large et plus fondu */}
      ...
      <section className="relative bg-gray-50" style={{ overflowX: 'clip' }}>
        ...
        <div className="container-kb px-4 pb-24">
          ...
          >
            <Link
              href="/realisations"
              className="inline-flex items-center gap-2 px-6 py-3 text-gray-700 font-medium hover:text-gray-900 transition-colors bg-white rounded-full shadow-md"
            >
      ...
      >
        <div className="relative overflow-hidden bg-[#0c0c1d]">
          ...
          {/* Section CTA */}
          <div className="relative z-10 px-6 md:px-12 lg:px-20 pt-16 md:pt-24 pb-16">
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              {/* Badge */}
              <span className="inline-block px-4 py-1.5 mb-6 text-sm font-medium rounded-full border border-blue-500/30 bg-blue-500/10 text-blue-400">
                Lancez votre projet
              </span>
              ...
              <p className="text-lg text-gray-400 mb-8 max-w-xl mx-auto">
                Discutons de vos objectifs et créons ensemble une solution sur mesure qui fera la différence.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link
                  href="/contact"
                  className="inline-flex items-center justify-center px-8 py-4 rounded-full border border-gray-700 bg-white/5 backdrop-blur-sm text-white font-semibold transition-all duration-300 hover:bg-white/10 hover:border-gray-600"
                >
                  Nous contacter
                </Link>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-8">
              ...
              <div className="lg:col-span-1">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-xl font-bold text-white">KB-COM</span>
                </div>
                ...
                <div className="flex gap-3">
                  <a href="#" className="w-10 h-10 rounded-full bg-white/5 border border-gray-800 flex items-center justify-center text-gray-400 hover:text-white hover:bg-white/10 hover:border-gray-700 transition-all">
