...
export default function NewArticlePage() {
  ...
  // Auto-générer l'extrait et le temps de lecture quand le contenu change
  useEffect(() => {
    if (formData.content) {
      const autoExcerpt = generateExcerpt(formData.content)
      const autoReadingTime = calculateReadingTime(formData.content)

      setFormData(prev => ({
        ...prev,
        excerpt: prev.excerpt || autoExcerpt, // Ne remplace que si vide
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-0.5">Créez un nouvel article de blog</p>
        </div>
      </div>
        ...
        <div className="col-span-2 space-y-6">
          ...
          <div className="relative">
            ...
            <div className="relative bg-white/70 backdrop-blur-xl rounded-2xl border border-white/50 p-6 shadow-xl shadow-black/5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Pourquoi Next.js est idéal pour votre"
                  />
                </div>
                <div>
              ...
              <p className="text-xs text-gray-400 mt-3">La partie accentuée sera colorée dans le titre affiché</p>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative bg-white/70 backdrop-blur-xl rounded-2xl border border-white/50 p-6 shadow-xl shadow-black/5">
              ...
              />
              <p className="text-xs text-gray-400 mt-2">Collez votre contenu HTML. L&apos;extrait et le temps de lecture sont calculés automatiquement.</p>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative bg-white/70 backdrop-blur-xl rounded-2xl border border-white/50 p-6 shadow-xl shadow-black/5">
              ...
              <textarea
                ...
                placeholder="Extrait auto-généré depuis le contenu..."
              />
