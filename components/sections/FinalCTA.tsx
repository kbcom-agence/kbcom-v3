...
export function FinalCTA() {
  return (
    <section className="from-primary to-primary-dark bg-gradient-to-br py-20">
      <div className="container mx-auto px-4 text-center md:px-8 lg:px-12">
        ...
        <Link
          href="/contact"
          className="text-primary mb-6 inline-flex items-center gap-2 rounded-xl bg-white px-8 py-3 text-base font-semibold transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-50 hover:shadow-lg focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
        >
          Demander un Devis
